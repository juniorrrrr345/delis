...
// Redéploiement forcé - Nouveau chargement DELIS FOOD MARKET
...
export default function HomePage() {
  ...
  const loadAllData = async () => {
    try {
      ...
      console.error('❌ Erreur chargement DELIS FOOD MARKET:', error);
      setProducts([]);
          ...
          <div className="min-h-screen loading-screen flex items-center justify-center p-4">
            <div className="text-center bg-black/60 backdrop-blur-md rounded-3xl p-8 sm:p-12 max-w-lg mx-auto border border-white/20">
              ...
              <div className="w-80 max-w-full mx-auto mb-8">
                ...
                <div className="mt-2 text-sm text-blue-300 font-medium drop-shadow-md animate-pulse">Chargement de DELIS FOOD MARKET...</div>
              </div>
